...
Функция ВыполнитьФоновоеЗаданиеНаСервере()
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения,
		"Обработки.ВКМ_МассовоеСозданиеАктов.ЗаполнитьНаСервере", Объект.Период.ДатаНачала, Объект.Период.ДатаОкончания);
...
Процедура ЗаполнитьОбработкуАктамиЗаПериод(СписокРеализацийМассив)
	...
	Для Каждого СписокРеализацияСтруктура Из СписокРеализацийМассив Цикл
		...
		НоваяСтрока.ДокументРеализации = СписокРеализацияСтруктура.Реализация;
